/**
 * Capítulo VII: Vocación y carrera. Viene de la segunda llamada a Claude
 * (areas_de_vida.vocacion).
 */
function Vocacion({ datos, onVolver }) {
    const texto = datos?.areas_de_vida?.vocacion
    ...
    return (
      <div className="max-w-md mx-auto px-6 pt-10">
        ...
        <h1 className="font-serif text-2xl text-[#3D5A6C] mb-6">Vocación y Carrera</h1>
